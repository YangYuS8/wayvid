...
pub fn vertex_shader_spirv() -> Vec<u32> {
    ...
    vec![
        ...
        0x000f0003, 0x00000000, 0x00000004, 0x6e69616d, 0x00000000,
        0x00000009, 0x0000000d, 0x0000001a,
        // OpSource GLSL 450
        ...
        0x000200f8, 0x00000005, // Label
        // Load vertex index
        0x0004003d, 0x00000006, 0x00000011, 0x00000009,
        // Create position based on vertex index (simplified)
        0x00050051, 0x0000000a, 0x00000012, 0x0000000e, 0x00000000,
        0x00050051, 0x0000000a, 0x00000013, 0x0000000e, 0x00000001,
        0x00070050, 0x0000000b, 0x00000014, 0x00000012, 0x00000013, 
        0x00000010, 0x0000000f, // vec4(x, y, 0, 1)
        // Store position
        0x0003003e, 0x0000000d, 0x00000014,
        // Create and store tex coord
        0x00050050, 0x00000018, 0x00000015, 0x00000010, 0x00000010,
        0x0003003e, 0x0000001a, 0x00000015,
        // Return
        0x000100fd,
...
pub fn fragment_shader_spirv() -> Vec<u32> {
    ...
    vec![
        ...
        0x000f0004, 0x00000004, 0x00000004, 0x6e69616d, 0x00000000,
        ...
        // Create white color
        0x00070050, 0x0000000a, 0x0000000f, 0x0000000d, 0x0000000d,
        0x0000000d, 0x0000000d, // vec4(1,1,1,1)
        // Store output
        0x0003003e, 0x0000000c, 0x0000000f,
        // Return
        0x000100fd,
        0x00010038,
    ]
