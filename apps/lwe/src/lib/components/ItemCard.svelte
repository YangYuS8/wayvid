...
<Card
  class={`lwe-panel-compact group transition duration-150 hover:-translate-y-0.5 hover:border-slate-300/80 hover:shadow-[0_24px_56px_rgba(15,23,42,0.12)] ${selected ? 'border-slate-900/80 ring-1 ring-slate-900/10' : ''}`}
>
